...
shipkit ships `scripts/wake_monitor.py` — a zero-dependency, cross-platform,
...
(`scripts/wake_monitor.py`) if you don't want the dependency.
...
def _require_watchdog():
    try:
        ...
        sys.stderr.write(
            ...
            "or use the shipped zero-dep poll version: scripts/wake_monitor.py\n"
        )
        return False
